...
OpenDataGraph v1.6.0 is distributed under `FSL-1.1-ALv2`. By submitting a contribution, you represent that you have the right to provide it and agree that it may be distributed under the project license.
