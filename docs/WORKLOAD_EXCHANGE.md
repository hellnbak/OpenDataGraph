...
OpenDataGraph v1.9 exchanges mounted or environment-referenced subject tokens for temporary AWS, Azure, or Google Cloud credentials. It does not persist subject tokens, access tokens, session keys, or returned credentials.
