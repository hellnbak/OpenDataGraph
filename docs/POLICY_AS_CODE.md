...
Standard controls include `tenant-context`, and policy audits remain in the authenticated tenant. v1.3 adds versioned bundles, review state, activation, rollback, and expiring exceptions. See [Policy governance](POLICY_GOVERNANCE.md).
